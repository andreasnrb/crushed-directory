<div class="wrap">
	...
	<div id="poststuff">
		...
		style="border: none; background: transparent;"><?php wp_nonce_field( 'new-mailmessage'); ?>
		<div class="postbox open">
			...
			<div class="inside">
				<table class="form-table">
					...
					<tr>
						<th colspan="2"><label for="mail_excerpt"><strong><?php _e('Mail plain','crusheddirectory')?></strong></label></th>
					</tr>
					<tr>
						<td colspan="2"><textarea id="mail_plain" name="mail-plain" cols="100"><?php echo stripslashes($mail->plain)?></textarea><br />
						<?php _e('<strong>Required:</strong> The mail message in plain text.', 'crusheddirectory'); ?>
						</td>
					</tr>
					<tr>
						<th colspan="2"><label for="mail_excerpt"><strong><?php _e('Mail HTML','crusheddirectory')?></strong></label></th>
					</tr>
					<tr>
						<td colspan="2"><textarea id="mail_html" name="mail-html" cols="100"><?php echo stripslashes($mail->html)?></textarea><br />
